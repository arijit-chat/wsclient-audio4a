...
Name:    agl-libclient-audio4a
Version: 1.0
Release: 1
Group:   AGL
License: APL2.0
Summary: Lib Client for Hight Level AGL audio-4a
Url:     https://github.com/iotbzh/libclient-audio4a
...
%define _prefix /opt/AGL/libclient-audio4a
%define __cmake cmake

%description
Lib Client for Hight Level AGL audio-4a
